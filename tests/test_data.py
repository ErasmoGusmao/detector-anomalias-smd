"""Testes unitários para o módulo de carregamento de dados (src/data/loader.py).
    ...
    Verifica que o pipeline de leitura carrega corretamente os arquivos,
    produz DataFrames com o formato esperado e trata erros de caminho inexistente.
"""
...
class TestDataLoading(unittest.TestCase):
    ...
    def test_clean_data_removes_nan(self):
        ...
        df = pd.DataFrame({0: [1.0, None, 3.0], 1: [4.0, 5.0, 6.0]})
